...
const fetchMyInquiryList = async (page: number, size: number): Promise<PaginationResponseType<Inquiry>> => {
...
const fetchMyInquiryById = async (inquiryId: number):Promise<Inquiry> => {
...
export default { fetchMyInquiryList, fetchMyInquiryById, createInquiry, deleteInquiry, updateInquiry };
